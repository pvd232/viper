...
class _RecordingFetcher:
    ...
    def observe_snapshot(self, snapshot: StageResultSnapshot) -> None:
        """Retain complete membership when verification reads any member."""
        self.list_snapshot_files(snapshot)
...
class _BundleFetcher:
    ...
    def observe_snapshot(self, snapshot: StageResultSnapshot) -> None:
        """Mark complete membership consumed before reading a member."""
        self.list_snapshot_files(snapshot)
