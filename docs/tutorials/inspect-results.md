# Inspect and search completed runs

Run two copies of the CPU experiment, verify their records, restore a model,
and search their measurements. Then publish an observation about the fitted
slope. Run this from the repository root after the
...
Save the complete program as [examples/inspect_results.py](../../examples/inspect_results.py):
