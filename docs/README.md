...
| [System Impact Compiler](development/system-impact-compiler.md) | Test CodeQL localization and independent structural target conformance against ordinary agent execution |
