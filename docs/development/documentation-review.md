...
| Durable GCS publication, restoration, and local eviction | [API reference](../reference/api.md#google-cloud-storage), [protocol reference](../reference/protocol.md#workspace-and-cloud-paths) | [test_gcs_storage.py](../../tests/test_gcs_storage.py), [test_retention.py](../../tests/test_retention.py), and cloud-backed execution cases |
