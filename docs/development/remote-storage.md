...
targets = [
    ...
    "tests/test_release_tools.py:HuggingFaceFileRef",
    "tests/test_release_tools.py:test_publish_binds_compact_evidence_to_one_hugging_face_commit",
    "tests/test_run_execution.py:snapshot_identity",
    "tests/test_run_execution.py:test_two_stage_local_run_writes_and_verifies_terminal_result",
    "tests/test_storage.py:test_storage_resolved_files_share_one_revision",
    "tests/test_verification_acceptance.py:snapshot_revision",
    "tests/test_verification_acceptance.py:build_benchmark_fixture",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_bundle_rejects_an_unrecorded_published_member",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_bundle_rejects_a_missing_recorded_member",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_run_separates_stage_results_from_attempt_files",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_confirmation_separates_stage_results_from_attempt_files",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_strict_benchmark_verifies_confirmation_input_lineage",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_strict_benchmark_verifies_confirmation_stored_inputs",
    "tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_promoted_artifact_verifies_producer_input_lineage",
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=add target=tests/test_verification_acceptance.py:StageResultSnapshot -->
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=add target=tests/test_verification_acceptance.py:ViperCloudFileRef -->
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=add target=tests/test_verification_acceptance.py:ViperCloudStageResultSnapshotRef -->
```python contract-target
from viper.references import (
    ArtifactPointerRef,
    GitFileRef,
...
```
<!-- contract-target: requirements=RSP-05 block=P9-RSP-01 action=update target=tests/test_plan_execution.py:test_source_and_plan_revisions_are_independent -->
```python contract-target
...
<!-- contract-target: requirements=RSP-05 block=P9-RSP-01 action=update target=tests/test_plan_execution.py:test_plan_documents_share_one_storage_revision -->
```python contract-target
...
<!-- contract-target: requirements=RSP-04 block=P9-RSP-01 action=add target=tests/test_release_tools.py:HuggingFaceFileRef -->
```python contract-target
from viper.references import HuggingFaceFileRef
```

<!-- contract-target: requirements=RSP-04 block=P9-RSP-01 action=update target=tests/test_release_tools.py:test_publish_binds_compact_evidence_to_one_hugging_face_commit -->
```python contract-target
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=add target=tests/test_run_execution.py:snapshot_identity -->
```python contract-target
from viper._verification.storage import read_attempt_reference, snapshot_identity
```

<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_run_execution.py:test_two_stage_local_run_writes_and_verifies_terminal_result -->
```python contract-target
def test_two_stage_local_run_writes_and_verifies_terminal_result(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
...
<!-- contract-target: requirements=RSP-04 block=P9-RSP-01 action=update target=tests/test_storage.py:test_storage_resolved_files_share_one_revision -->
```python contract-target
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=add target=tests/test_verification_acceptance.py:snapshot_revision -->
```python contract-target
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:build_benchmark_fixture -->
```python contract-target
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_bundle_rejects_an_unrecorded_published_member -->
```python contract-target
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_bundle_rejects_a_missing_recorded_member -->
```python contract-target
class CompleteProvenanceAcceptanceTests:
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_run_separates_stage_results_from_attempt_files -->
```python contract-target
class CompleteProvenanceAcceptanceTests:
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_confirmation_separates_stage_results_from_attempt_files -->
```python contract-target
class CompleteProvenanceAcceptanceTests:
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_strict_benchmark_verifies_confirmation_input_lineage -->
```python contract-target
class CompleteProvenanceAcceptanceTests:
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_strict_benchmark_verifies_confirmation_stored_inputs -->
```python contract-target
class CompleteProvenanceAcceptanceTests:
...
<!-- contract-target: requirements=RSP-06 block=P9-RSP-01 action=update target=tests/test_verification_acceptance.py:CompleteProvenanceAcceptanceTests.test_promoted_artifact_verifies_producer_input_lineage -->
```python contract-target
class CompleteProvenanceAcceptanceTests:
