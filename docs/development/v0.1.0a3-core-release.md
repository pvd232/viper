...
|---|---|
| Preservation branch | Exact pre-cleanup commit and complete experimental history. |
| Cleanup commit | Only the approved removals and their required reference repairs. |
...
- [ ] `P0-CRB-01`: Push the preservation branch and verify its remote commit.
- [ ] `P0-CRB-02`: Remove the Section 8 experimental paths and repair all
  imports, registries, tests, and documentation that they owned.
- [ ] `P0-CRB-03`: Retain and retest knowledge/MCP, remove the unused `usearch`
