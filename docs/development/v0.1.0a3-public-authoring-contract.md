...
flowchart TD
    ...
    class Download,Build,Embed,Train,Eval,Diagnostic,Loop,Update implementation
...
15. Update generated workspaces, docs, examples, schemas, CLI and MCP
...
| `P3-PAC-07` | `PAC-07` | `PAC-10` | Public inventory and documentation acceptance |
