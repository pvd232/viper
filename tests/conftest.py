...
TIER_BY_MODULE = {
    ...
    "test_gcs_storage": "contract",
    "test_http_retrieval": "contract",
    "test_impact_graph_build": "unit",
    "test_impacted_test_selection": "unit",
    "test_test_impact": "unit",
    "test_unittest_test_selection": "unit",
    ...
    "test_retention": "contract",
    "test_release_tools": "unit",
    "test_resume": "integration",
    "test_run_execution": "integration",
    "test_execution_signals": "integration",
    "test_export": "integration",
    "test_execution_policy_controls": "integration",
    "test_execution_policy_acceptance": "integration",
    "test_stage_invocation": "contract",
    "test_stage_file_access": "unit",
...
DOMAIN_BY_MODULE = {
    ...
    "test_cloud_service": "domain_storage",
    ...
    "test_execution_policy_controls": "domain_execution",
    "test_execution_policy_acceptance": "domain_execution",
    "test_generated_project_acceptance": "domain_release",
    "test_gcs_storage": "domain_storage",
    "test_http_retrieval": "domain_http",
    "test_impact_graph_build": "domain_protocol",
    "test_impacted_test_selection": "domain_protocol",
    "test_test_impact": "domain_protocol",
    "test_unittest_test_selection": "domain_protocol",
    ...
    "test_export": "domain_execution",
    "test_stage_invocation": "domain_execution",
    "test_stage_file_access": "domain_execution",
