"""Planned acceptance tests for the PAC-10 runtime boundary."""
...
PLANNED_DESTINATION = "tests/test_runtime_boundary.py"
...
def _stateful_metric_type(metrics: Any) -> type[Any]:
    """Create one valid stateful metric against the runtime module."""

    class TestMetric(metrics.StatefulMetric):
